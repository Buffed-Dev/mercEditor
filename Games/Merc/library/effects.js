 ...
 * a effect.json in it, so the folder *is* the record — copy the directory and
 * you have copied the effect, pictures and all. A list here would be a
...
let found;
try {
  found = import.meta.glob('../assets/**/effect.json', { eager: true, import: 'default' });
} catch {
  found = {};
}

export const VFX = recordsFrom(found, 'effect.json');
