 ...
 * a terrain.json in it, so the folder *is* the record — copy the directory and
 * you have copied the terrain, pictures and all. A list here would be a
...
let found;
try {
  found = import.meta.glob('../assets/**/terrain.json', { eager: true, import: 'default' });
} catch {
  found = {};
}

export const TERRAINS = recordsFrom(found, 'terrain.json');
